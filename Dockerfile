...
CMD ["sh", "-c", "echo 'Current working directory:' && pwd && ls -la && echo 'Environment:' && env | grep -v PASSWORD && echo 'Starting database initialization...' && node init-db.js && echo 'Starting application...' && npm run start"]